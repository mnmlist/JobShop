...
public class Operation {
     ...
     * identification.
     *
     * @param d              The time needed to process this operation.
     * @param j              The job to which the operation belongs.
     * @param m              The machine on which the operation should be processed.
     * @param identification The id of the operation.
     */
