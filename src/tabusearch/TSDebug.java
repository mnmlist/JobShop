...
public class TSDebug {
     ...
     */
    public  Solution tabuSearch(Problem p) {
    ...
    public  Solution its(Solution p, int mode) {
        Solution s = p;
        float bestCost = s.getCost();
        Solution bestSol = s;
     ...
     * @return
     */
    private  boolean checkStoppingRule(int k,
     ...
     * @throws Exception If
     */
    private  Move chooseRandomMoveFromSet(HashSet<Move> inversions) {
     ...
     */
    public  Solution getInitialSolution(Problem p) {
     ...
     * getInitialSolution.
     */
    public  Solution getInitialSolutionOnlyLeft(Problem p) {
        // initialisation: sets of scheduled operations
        HashSet<Operation> l = new HashSet<Operation>();
        HashSet<Operation> r = new HashSet<Operation>();
        Solution initSol = new Solution(p);
     ...
     */
    private  Entry<Operation, Integer> chooseOperationListSchedulePriorityRule(
    ...
    private  Entry<Operation, Integer> chooseOperationSemiGreedy(
            HashMap<Operation, Integer> t) {
     ...
     * map.
     */
    private  <K, V extends Comparable<? super V>> List<Entry<K, V>> findSmallest(
            Map<K, V> map, int n) {
     ...
     */
    private  final int MAXITER = 1200;
     ...
     * tabu search.
     */
    private  final int SAFETY_STOP = 5 * getMaxiter();

    /**
     * @return the safetyStop
     */
    public  int getSafetyStop() {
        return SAFETY_STOP;
    }
